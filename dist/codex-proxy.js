...
export function extractPathAndSearch(url) {
...
function removeForwardedClientHeaders(headers) {
    for (const name of [
        'accept-encoding',
        'connection',
        'content-length',
...
async function summarizeUpstreamError(alias, response, parsedPayload) {
...
export async function handleCodexProxyRequest(input, init, options) {
